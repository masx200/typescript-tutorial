...
// let window = { ...oldwindow, MathJax };
if (document.getElementById && document.childNodes && document.createElement) {
    if (!(MathJax && MathJax.Hub)) {
        // if (MathJax) {
        //   MathJax = { AuthorConfig: MathJax };
        // } else {
        //   MathJax = {};
        // }
        ...
        (function (BASENAME) {
            var BASE = MathJax[BASENAME];
            if (!BASE) {
                BASE = MathJax[BASENAME] = {};
            }
                    ...
                    if (f.hasOwnProperty("style")) {
                        ...
                        for (h in c) {
                            if (c.hasOwnProperty(h)) {
                                f.style[h.replace(/-([a-z])/g, this.ucMatch)] =
                                    c[h];
                            }
                        }
                    }
                ...
                if (e) {
                    ...
                    for (var b = 0, a = e.length; b < a; b++) {
                        if (MathJax.Object.isArray(e[b])) {
                            g.appendChild(
                                this.Element(e[b][0], e[b][1], e[b][2])
                            );
                        } else {
                            if (d === "script") {
        ...
        MathJax.Localization = {
                ...
                for (var d = 0, b = e.length; d < b; d++) {
                    if (MathJax.Object.isArray(e[d])) {
                        ...
                        if (typeof f[1] === "string") {
                            ...
                            c = c.concat(
                                this.processMarkdown(a, f.slice(2), g)
                            );
                        } else {
                            if (MathJax.Object.isArray(f[1])) {
                                c = c.concat(
                                    this.processSnippet.apply(this, f)
                                );
                            } else {
                                if (f.length >= 3) {
                                    c.push([
            ...
            resetLocale: function (a) {
                ...
                this.locale = b ? b : a;
                MathJax.Callback.Signal("Hub").Post([
                    "Locale Reset",
                    this.locale,
                ]);
            },
        ...
        MathJax.Message = {
            ...
            Set: function (c, e, b) {
                ...
                if (MathJax.Object.isArray(c)) {
                    ...
                    try {
                        c = MathJax.Localization._.apply(
                            MathJax.Localization,
                            c
                        );
                    } catch (a) {
        ...
        MathJax.Hub = {
            ...
            isJax: function (a) {
                ...
                if (a && (a.tagName || "").toLowerCase() === "script") {
                    if (a.MathJax) {
                        return a.MathJax.state ===
                            MathJax.ElementJax.STATE.PROCESSED
                            ? 1
                            : -1;
                    }
                    if (
            ...
            isMathJaxNode: function (a) {
                return (
                    !!a &&
                    (a.isMathJax || (a.className || "") === "MathJax_MathML")
                );
            },
        ...
        (function (d) {
            ...
            b.InputJax = g.Subclass(
                {
                    ...
                    Process: function (l, q) {
                        ...
                        if (k) {
                            j.Push(
                                a.Require(k[0].directory + "/" + this.JAXFILE)
                            );
                        }
                        return j.Push({});
                    },
            ...
            b.OutputJax = g.Subclass(
                {
                    ...
                    Process: function (h) {
                        throw Error(
                            this.id + " output jax failed to load properly"
                        );
                    },
                    Register: function (i) {
                        var h = c.outputJax;
            ...
            b.OutputJax.Error = {
                ...
                Jax: function (j, i) {
                    var h =
                        MathJax.Hub.inputJax[i.type.replace(/ *;(.|\s)*/, "")];
                    this.errors++;
                    return {
        ...
        (function (o) {
            ...
            try {
                d.Browser.Select({
                    Safari: function (j) {
                        ...
                        j.isMobile =
                            navigator.appVersion.match(/Mobile/i) != null;
                        j.noContextMenu = j.isMobile;
                    },
                    Firefox: function (j) {
                        if (
                            (j.version === "0.0" ||
                                k.match(/Firefox/) == null) &&
                    ...
                    MSIE: function (j) {
                        ...
                        MathJax.Hub.msieHTMLCollectionBug =
                            document.documentMode < 9;
                        if (
                            document.documentMode < 10 &&
                            !s.params.NoMathPlayer
                        ) {
                            try {
            ...
            if (
                h.AuthorConfig &&
                typeof h.AuthorConfig.AuthorInit === "function"
            ) {
